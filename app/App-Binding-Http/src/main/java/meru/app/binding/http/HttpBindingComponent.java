...
public class HttpBindingComponent extends BindingComponent<HttpEntityRequest> {
  ...
  protected void postBindingSpecific(HttpEntityRequest entityRequest) throws IOException {
    ...
    sendEntity(entity, entityRequest);

  }

  @Override
  protected void deleteBindingSpecific(HttpEntityRequest entityRequest) throws IOException {
    Object id = entityRequest.getEntityId();
    if (id != null) {

      Object result = mAppEngine.remove(getEntityClass(entityRequest.getEntityName()),
                        id);
      if (result != null) {
        sendEntity(result, entityRequest);
      }
    }
  ...
  private void sendEntity(Object entity, HttpEntityRequest entityRequest) throws IOException {
