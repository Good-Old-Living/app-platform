...
public abstract class AppServlet extends HttpServlet {
  ...
  public void init(ServletConfig config) throws ServletException {
    ...
    mBindingComponent = (HttpBindingComponent) BindingComponentRegistry.getInstance().getBindingComponent(
        HttpBindingComponent.TYPE);
  ...
  protected final HttpAppRequest getAppRequest(HttpServletRequest request, HttpServletResponse response)
  ...
  protected HttpAppRequest getAppRequestInstance(HttpServletRequest request, HttpServletResponse response)
      throws UnsupportedEncodingException {
    HttpAppRequest appRequest = new HttpAppRequest(getRequestURL(request), request, response);
  ...
  protected void delete(HttpAppRequest appRequest) throws ServletException, IOException {
  ...
  private boolean handleException(Exception e, HttpServletRequest request, HttpServletResponse response) {
    ...
    } catch (IOException | SecurityException | IllegalStateException | SystemException | RollbackException
  ...
  private boolean processException(Exception e, HttpServletRequest request, HttpServletResponse response)
      throws IOException {

    ExceptionHandlerFactory.getExceptionHandler(e.getClass()).handle(e,
        request,
        response);
  ...
  protected void write(Object object, HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    if (accept != null && accept.equals("application/json")) {
      ...
      message = MediaTypeFactory.getMediaType("application/json").encode(object);
