...
public class EntityAppEngine extends AppEngine {
  ...
  public EntityAppEngine(AppConfig appConfig,
    ...
    mTransactionManager = serviceManager.getService(ServiceManager.SERVICE_TRANSACTION_MANAGER,
  ...
  @Override
  public <T> Object remove(Class<T> entityClass,
                           Object id) {
  ...
  public Object saveEntity(Object resource) {
    ...
    if (id == null) {
      ...
      // id = uid.getId();
      // ClassHelper.setFieldValue(resource, "id", id);
  ...
  public <T> Object removeEntity(Class<T> resourceClass,
                                 Object id) {
      ...
      for (Field field : fields) {
        ...
        if (value != null) {
          ...
          if (!ClassHelper.isBuildInJavaTypes(type)) {
            ...
            id = ClassHelper.getFieldValue(value,
                                           "id");
            if (id != null) {
