...
public class AppConfig {
	...
	@XmlAttribute(name = "propertyManager")
	private String propertyManagerClass;
	...
	public Class<?> getPropertyManagerClass() throws ClassNotFoundException {
		if (propertyManagerClass == null || propertyManagerClass.trim().equals("")) {
			return null;
		}

		return Class.forName(propertyManagerClass);
	}

	public Class<?> getApplicationClass() throws ClassNotFoundException {
		if (appClass == null || appClass.trim().equals("")) {
			return null;
		}
