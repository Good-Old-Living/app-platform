...
public class HttpHandler {
  ...
  protected Object get(String url) {
    ...
    try {
      ...
      objectInputStream = new ObjectInputStream(response.getEntity().getContent());
  ...
  protected Object post(String url, String data, String contentType) {
    ...
    ObjectInputStream objectInputStream = null;
    try {
      httpPost.setEntity(new StringEntity(data, ContentType.create(contentType)));
      ...
      if (response.getEntity() != null) {
        ...
        if (httpEntity.getContentType() != null) {
          String cType = httpEntity.getContentType().getValue();
