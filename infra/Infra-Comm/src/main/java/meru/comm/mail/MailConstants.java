...
public interface MailConstants {
  ...
  public static final String MAIL_SERVER_USER = "mail.server.user";
  public static final String MAIL_SERVER_PASSWORD = "mail.server.password";
  public static final String MAIL_INBOUND_PROTOCOL = "mail.inbound.protocol";
  ...
  public static final String MAIL_SMTP_STARTTLS_ENABME = "mail.smtp.starttls.enable";
